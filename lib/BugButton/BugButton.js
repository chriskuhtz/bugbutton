...
var BugButton = function (_a) {
    ...
    if (condition === true && authToken !== "" && url !== "") {
        return (React.createElement(React.Fragment, null,
            React.createElement("button", { className: "bugButton", style: {
                    position: "absolute",
                    ...
                    borderBottomRightRadius: ["left", "top"].includes(position)
                        ? "0.5rem"
                        : undefined,
                }, onClick: function () { return setShowModal(true); } }, "BUG"),
            React.createElement("div", { className: showModal ? "bugModal stack" : "displayNone", style: {
                    position: "absolute",
                    top: position === "top" ? 0 : undefined,
                    right: position === "right" ? 0 : undefined,
                ...
                React.createElement("div", { className: "closeButtonBox" },
                    React.createElement("button", { className: "closeButton", onClick: function () { return setShowModal(false); } }, "X")),
                ...
                categories && (React.createElement("div", null,
                    ...
                    React.createElement("section", { id: "categoryButtonGroup" }, categories.map(function (c, i) { return (React.createElement("button", { className: "".concat(category === c
                            ? "selectedCategoryButton"
                            : "categoryButton", " ").concat(i === 0 && "firstButton", " ").concat(i === categories.length - 1 && "lastButton", " "), onClick: function () { return setCategory(c); } }, c)); })))),
                React.createElement("div", null,
                ...
                React.createElement("p", null, linkToIssue && (React.createElement("a", { target: "_blank", href: linkToIssue.url }, "Issue ".concat(linkToIssue.number, " created successfully")))),
                React.createElement("button", { disabled: description === "" || title === "" || reporter === "", className: "reportButton", onClick: handleReportClick }, "Report"))));
    }
    else
        return React.createElement(React.Fragment, null);
};
